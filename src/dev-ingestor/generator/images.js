...
function buildCatalogue() {
  ...
  const gradients = [
    ...
    { key: "Cyberpunk", from: [255, 0, 128], to: [0, 255, 255] },
    { key: "Tropical", from: [0, 255, 128], to: [255, 255, 0] },
    { key: "Velvet", from: [100, 0, 50], to: [40, 0, 20] },
    { key: "Peach", from: [255, 200, 150], to: [255, 100, 100] },
    { key: "Mint", from: [150, 255, 200], to: [50, 150, 150] },
  ];
  ...
  const crops = [
    ...
    { key: "2.35:1 Cinematic", w: 1, h: 0.75 },
    { key: "4:3 Classic", w: 0.75, h: 1 },
  ];
