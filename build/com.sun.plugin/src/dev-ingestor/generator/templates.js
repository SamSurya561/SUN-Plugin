...
function buildCatalogue() {
  ...
  const mogrtGroups = [
    { category: "titles", layout: "title", styles: ["Cinematic", "Minimal", "Bold", "Serif", "Kinetic", "Split", "Boxed", "Underline", "Fade", "Slide", "Retro", "Neon", "Corporate", "News", "Sports", "Vlog", "Gaming", "Elegant", "Glitch", "Typewriter"], count: 20 },
    { category: "lower-thirds", layout: "lower-third", styles: ["Clean", "Bar", "Corner", "Rounded", "Outline", "Gradient", "Broadcast", "Minimal", "News", "Sports", "Social", "Elegant", "Tech", "Glitch", "Simple"], count: 15 },
    { category: "captions", layout: "caption", styles: ["Subtitle", "Karaoke", "Pop", "Highlight", "Boxed", "Shadow", "Neon", "Typewriter", "Bounce", "Scale"], count: 10 },
    { category: "kinetic-typography", layout: "title", styles: ["Bounce", "Scale", "Typewriter", "Wave", "Stagger", "Rotate", "Stretch", "Squeeze", "Shake", "Jiggle", "Drop", "Rise"], count: 12 },
    { category: "text-animations", layout: "title", styles: ["Fade In", "Slide Up", "Mask Reveal", "Blur In", "Scale In", "Whip", "Zoom", "Flip", "Spin"], count: 9 },
    { category: "transitions", layout: "transition", styles: ["Whip", "Zoom", "Glitch", "Shape", "Light", "Film", "Wipe", "Dissolve", "Paint", "Ink", "Grid", "Slice", "Push", "Slide", "Iris"], count: 15 },
    { category: "logo-reveals", layout: "logo", styles: ["Shine", "Assemble", "Fade", "Stamp", "Draw", "Explode", "Implode", "Liquid", "Tech", "Glitch", "Particle", "Light Ray"], count: 12 },
    { category: "infographics", layout: "callout", styles: ["Bar Chart", "Pie", "Counter", "Timeline", "Stat", "Graph", "Percentage", "Map", "Comparison"], count: 9 },
    { category: "social", layout: "lower-third", styles: ["Subscribe", "Handle", "Like", "Comment", "Follow", "Share", "Bell", "End Screen", "Swipe Up", "Profile"], count: 10 },
    { category: "callouts", layout: "callout", styles: ["Arrow", "Circle", "Line", "Box", "Pointer", "Bracket", "Highlight", "Magnify"], count: 8 },
    { category: "overlays", layout: "transition", styles: ["VHS", "Film Frame", "Viewfinder", "Camera UI", "Grid", "Crosshair", "Letterbox", "CRT"], count: 8 },
  ];
  ...
  // --- presets
  const presetGroups = [
    { category: "motion", names: ["Smooth Zoom In", "Smooth Zoom Out", "Handheld Shake", "Slow Push", "Whip Pan", "Ease Slide", "Drift", "Snap Scale", "Earthquake", "Subtle Shake", "Pan Left", "Pan Right", "Tilt Up", "Tilt Down", "Wobble", "Jitter", "Bounce In", "Bounce Out"] },
    { category: "effect", names: ["Glow Soft", "Glitch RGB", "Chromatic Aberration", "Vignette Soft", "Sharpen Light", "Blur Edges", "Lens Flare", "Light Leak", "Film Grain", "VHS Noise", "CRT Scanlines", "Pixelate", "Emboss", "Find Edges", "Posterize", "Solarize", "Threshold", "Halftone"] },
    { category: "audio", names: ["Voice Clarity", "Bass Boost", "De Ess", "Podcast Master", "Telephone", "Radio", "Megaphone", "Muffled", "Underwater", "Echo Chamber", "Hall Reverb", "Room Reverb", "Studio Dry", "Compressor Hard", "Gate Noise"] },
    { category: "text", names: ["Fade Text", "Pop Text", "Slide Text", "Blur Text", "Typewriter Effect", "Glitch Text", "Neon Glow", "Drop Shadow", "Inner Shadow", "Stroke Outline", "Gradient Fill", "Texture Fill"] },
    { category: "speed", names: ["Speed Ramp Up", "Speed Ramp Down", "Freeze Frame", "Slow Motion", "Time Lapse", "Reverse", "Stutter", "Stop Motion", "Hyperlapse"] },
    { category: "stabilize", names: ["Warp Subtle", "Warp Strong", "Lock On", "Smooth Tracking", "Tripod Fix"] },
    { category: "color", names: ["Teal Orange", "Film Emulation", "Vintage Faded", "Bleach Bypass", "High Contrast", "Black and White", "Sepia", "Cyanotype", "Night Vision", "Thermal", "Color Isolate Red", "Color Isolate Blue"] }
  ];
